{pkgs, ...}: {
  programs.neovim = {
    extraPackages = with pkgs; [
      ...
      nodePackages.typescript # required by volar
      # TODO no package for @vue/language-server
    ...
    plugins = with pkgs.vimPlugins; [
        ...
        config =
          ...
          */
          ''
                   ...
                   --})
                   add_lsp("volar", lspconfig.volar, {
                            filetypes = {'typescript', 'javascript', 'javascriptreact', 'typescript', 'typescriptreact', 'vue'},
                     init_options = {
                              typescript = {
                         -- Use global typescript server
                                tsdk = '${pkgs.nodePackages.typescript}/lib/node_modules/typescript/lib/'
                              }
                            }
                          })
            add_lsp("eslint", lspconfig.eslint, {})
      ...
      }
      {
        ...
        config =
          ...
          */
          ''
                         -- null-ls: black, semgrep, sqlfluff
                         ...
                         null_ls.setup({
                             debug = false,
                             sources = {
               -- TODO re-enable code_actions for eslint: https://github.com/nvimtools/none-ls-extras.nvim
